...
def load_model():
    try:
        model = tf.keras.models.load_model(r'C:\Users\ayush\OneDrive\Desktop\hacakcinno\Audio-DeepFake-Detection-using-CNN-BiLSTM\savedmodels\updated_model.keras')
        return model
    except Exception as e:
